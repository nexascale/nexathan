...
class UserStatus(models.Model):
    """
    The availability status of a user, e.g. Online, Away, Offline, Busy, Available
    This could be used for IM between users. The table is auto-filled by the system
...
class User(models.Model):
    ...
    # Nexathan_yy8
    status = models.SmallIntegerField(_('online status'), default=0) #, _('current status'), help_text=_("The availability status of a user, such as Online, Offline, Away, Busy"))
    last_update = models.DateTimeField(_('last update'), default=datetime.datetime.now)
    from django.conf import settings
    timezone = models.CharField(_('time zone'), max_length=32, default=settings.TIME_ZONE)
