...
from nexathan.auth.urls import urlpatterns
from nexathan.auth.views import password_reset
...
urlpatterns = urlpatterns + patterns('',
    ...
    (r'^password_reset_from_email/$', 'nexathan.auth.views.password_reset', dict(from_email='staffmember@example.com')),
